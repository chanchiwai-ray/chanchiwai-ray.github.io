...
draft: false
summary: There are many ways to set up Kubernetes cluster for learning purpose, such as minikube or MicroK8s. In this post, I would like to introduce yet another way to deploy Kubernetes cluster with Canonical K8s.
---
...
In this post, I am going to show you how to set up a three nodes Kubernetes cluster on your local desktop or laptop for
